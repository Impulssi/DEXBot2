...
run('Native serializer snapshots', [path.join(__dirname, '..', 'tests', 'test_native_serial_ops.js')]);

run('Native ECC invariants', [path.join(__dirname, '..', 'tests', 'test_native_ecc.js')]);
