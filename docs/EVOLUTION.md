...
| v1.4.5 → v1.4.6 | 3 | AsyncLock nested re-entrancy fix (Set-based ALS store preserves outer lock identity), grid type reassignment on load to prevent ILLEGAL_SPREAD_STATE, single-value state hardening (FileLock re-entrancy, _bootstrapping/_broadcastingFlag refcounts, _currentWorkingGrid stack), nested multi-lock re-entrancy tests |

---

**Report Originally Generated**: February 19, 2026
**Last Updated**: July 29, 2026 (v1.4.6)
**Total Commits**: 1,902
