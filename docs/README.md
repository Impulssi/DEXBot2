...
**Version context:** v1.0.10 is the current release.
...
- **Coverage**: Historical milestones from the initial December 2025 bootstrap through the v1.0.10 stable release, including credit maintenance hardening
